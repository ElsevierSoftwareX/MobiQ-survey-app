...
public class OtherClubActivity extends Activity {

	
	Button mButton;  
	EditText mEdit;  
	TextView mText;
	String times_for_other;
		...
		setContentView(R.layout.input_text_submit);
	      ...
	      times_for_other=intent.getStringExtra("times_for_other");
			...
			//final EditText  mEdit = (EditText) this.findViewById(R.id.editTextPlainTextInput);
	         ...
	         mText.setText("Please type in the unlisted club activity done " + times_for_other + " times in the last week");
			...
			mButton.setOnClickListener(new View.OnClickListener() {
			            public void onClick(View view) {
			            	...
			            	if (!input.equalsIgnoreCase("")){
								...
								non_listed_activities.putString("otherClubsName", input);
