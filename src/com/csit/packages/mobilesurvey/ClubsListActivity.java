...
public class ClubsListActivity extends Activity {
...
public void button_click(View view) {
         ...
         if (checkboxLayout.getChildAt(i) instanceof CheckBox) {
             ...
             if (cb.isChecked()) {
               //  Toast.makeText(getApplicationContext(), cb.getText().toString(), Toast.LENGTH_SHORT).show();
             	...
             	clubs_results.putBoolean("clubs"+i, true);
 ...
 // Intent intent = new Intent(this, NonClubsListActivity.class);
  Intent intent = new Intent(this, ClubsRegularActivity.class);	     
  ...
  startActivity(intent);
    	 ...
    	 //Toast.makeText(getApplicationContext(), "please select one or more options or enter other club activity done", Toast.LENGTH_SHORT).show();
